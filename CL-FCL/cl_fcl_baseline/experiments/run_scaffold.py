...
from cl_fcl_baseline.algorithms.scaffold import ScaffoldClient, ScaffoldServer
...
try:
    from .args import parse_scaffold_args
except ImportError:  # pragma: no cover
    from cl_fcl_baseline.experiments.args import parse_scaffold_args


def main() -> None:
    global netmodel
    args = parse_scaffold_args()
    set_seed(args.seed)
    if args.device == "auto":
    ...
    if not log_path:
        ...
        log_path = str(log_dir / f"scaffold_{timestamp}.jsonl")
