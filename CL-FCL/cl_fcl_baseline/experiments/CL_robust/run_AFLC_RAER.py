...
from cl_fcl_baseline.algorithms.CL_robust.AFLC_RAER import AFLCRAERLearner
...
try:
    from ..args import parse_aflc_raer_args
except ImportError:  # pragma: no cover
    from cl_fcl_baseline.experiments.args import parse_aflc_raer_args
...
def main() -> None:
    ...
    learner = AFLCRAERLearner(
        ...
        calibration_alpha=args.aflc_alpha,
        raer_threshold=args.raer_threshold,
        future_prior=args.future_prior,
        adaptive_eval_attack=args.adaptive_eval_attack,
    )
    ...
    if not log_path:
        ...
        log_path = str(Path("logs") / f"cl_robust_aflc_raer_{stamp}.jsonl")
    else:
    ...
    print(f"AFLC_RAER finished. log={log_path}")
