...
from cl_fcl_baseline.algorithms.FAT import FedWeITFATClient, FedWeITFATServer
...
try:
    from .args import _parse_fedweit_fat_args
except ImportError:  # pragma: no cover
    from cl_fcl_baseline.experiments.args import _parse_fedweit_fat_args
...
def main() -> None:
    ...
    if not log_path:
        ...
        log_path = str(log_dir / f"fedweit_fat_{timestamp}.jsonl")
    else:
