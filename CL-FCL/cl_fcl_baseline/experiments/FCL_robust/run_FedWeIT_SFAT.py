...
from cl_fcl_baseline.algorithms.SFAT import FedWeITSFATClient, FedWeITSFATServer
...
from cl_fcl_baseline.experiments.fcl_robust import EXPERIMENTS_LOG_DIR
from cl_fcl_baseline.trainers.trainer import BaseTrainer
from cl_fcl_baseline.trainers.utils import set_seed

try:
    from .args import _parse_fedweit_sfat_args
except ImportError:  # pragma: no cover
    from cl_fcl_baseline.experiments.args import _parse_fedweit_sfat_args
...
def main() -> None:
    ...
    if not log_path:
        ...
        log_path = str(log_dir / f"fedweit_sfat_{timestamp}.jsonl")
    else:
